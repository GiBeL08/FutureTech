    ...
    <div className="p-8 space-y-8">
        ...
        <div className="space-y-3">
          {stats.map((s) => (
            <div key={s.id} className="flex items-center gap-3">
              <input className="bg-gray-800 text-white text-sm rounded-lg px-3 py-2 border border-gray-700 w-32 focus:outline-none focus:border-blue-500"
                defaultValue={s.value} onBlur={(e) => updateStat(s.id, e.target.value, s.label)} />
              <input className="bg-gray-800 text-white text-sm rounded-lg px-3 py-2 border border-gray-700 flex-1 focus:outline-none focus:border-blue-500"
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
        ...
        <div className="max-h-64 overflow-y-auto space-y-2">
          {subscribers.map((s) => (
            <div key={s.id} className="flex justify-between items-center py-2 border-b border-gray-800">
